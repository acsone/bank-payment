...
class AccountPaymentMode(models.Model):
    ...
    initiating_party_schema = fields.Char(
        string='Initiating Party Schema', size=35,
        help="This will be used as the 'Initiating Party Schema Name' in "
        "the PAIN files generated by Odoo. If not defined, no schema will "
        "be used.\n")
